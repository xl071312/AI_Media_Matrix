#!/usr/bin/env python3
"""RC8A: Research Handoff Repackage + Batch003 Ledger Fix (Fixed)"""
import json
import csv
...
if b003_001_found:
    ...
    print(f"Note: B003-001 not found in interim JSON files")
    print(f"  Will add to ledger directly")
...
for row in ledger_rows:
    if row.get('content_id') == b003_001_cid and row.get('batch') == 'batch_003':
        ...
        row['independent_observation'] = 'False'
...
if fixed_count == 0:
    ...
    new_row = {
        ...
        'content_type': 'VIDEO',
        'simulated': 'FALSE',
        'notes': 'B003-001 OFF_TOPIC fix - was counted incorrectly'
    }
...
with open(qa_path, 'w', encoding='utf-8') as f:
    ...
    f.write(f"- New Gap to 100: {100 - final_logic}\n")
