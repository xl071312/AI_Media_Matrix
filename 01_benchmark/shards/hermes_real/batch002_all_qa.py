#!/usr/bin/env python3
"""Batch 002 - Admission QA for all transcripts + continue production"""
import json
import csv
...
print(f"=== BATCH 002 ADMISSION QA - ALL ===")
print(f"Total audio files: {len(all_audio)}\n")

results = []
qualified_count = 0

for cid in sorted(all_audio):
...
print(f"Need: 30")
print(f"Still need: {max(0, 30 - qualified_count)}")

# Save
output = SHARDS / "batch002_all_qa.json"
