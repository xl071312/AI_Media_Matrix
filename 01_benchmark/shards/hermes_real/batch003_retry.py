#!/usr/bin/env python3
"""Batch 003 - Retry with different approach to avoid rate limiting"""
import csv
import json
import time
import random
...
# Load selection - get candidates NOT in registry
...
for i, c in enumerate(candidates[:20], 1):
    ...
    time.sleep(random.uniform(2, 4))  # Longer delay to avoid rate limit
